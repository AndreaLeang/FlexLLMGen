...
def layer_prediction(opt_config, is_load_store, batch_size, num_of_batches, offload_percent, recomp_len, prompt_len, gen_len, hardware_config, gpu_estimator, layer_type="MHA"):
    ...
    if is_load_store == 0:
        ...
        recomp_pinned_energy, recomp_pinned_latency = pinned_pred(recomp_bytes, hardware_config, gpu_estimator)
        ...
        tot_energy = recomp_pinned_energy + pinned_energy + recomp_transfer_energy + layer_calc_energy + k_transfer_energy + v_transfer_energy
      
        return tot_energy, recomp_pinned_latency + first_half_latency + second_half_latency, recomp_transfer_energy + k_transfer_energy + v_transfer_energy, layer_calc_energy
