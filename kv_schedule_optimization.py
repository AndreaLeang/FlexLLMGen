...
def disect_input(model, opt_config, num_of_prompts, prompt_len, gen_len, hardware_config, save_results, testing, fast, gpu_estimator, var_to_min="latency"):
    ...
    if testing: 
        ...
        batch_sizes = [1, 2, 4, 8]
        all_feasible_strategies_dict = {1: [100], 2:[50], 4:[60], 8:[80]}
    ...
    if save_results:
        csv_filename = "all_pred_model_totP_" + str(num_of_prompts) +"prompt_len_" + str(prompt_len) + "gen_len" + str(gen_len) + ".csv"
        print(csv_filename)
